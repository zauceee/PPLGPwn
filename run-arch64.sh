...
chmod +x ./pppwn-arch64
./pppwn-arch64 --interface $interface --fw $firmver --stage1 $stage1 --stage2 $stage2 --auto-retry
echo "./pppwn-arch64 --interface $interface -fw $firmver --stage1 $stage1 --stage2 $stage2" --auto-retry
